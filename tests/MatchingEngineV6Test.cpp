...
TEST(MatchingEngineV6, CancelAfterPartialFill_RemovesRestingRemainder_SellSide) {
    ...
    engine.processOrder(Side::BUY, Type::LIMIT, 100, 4);   // id 2, id 1 partially filled and still resting
...
TEST(MatchingEngineV6, CancelAfterPartialFill_RemovesRestingRemainder_BuySide) {
    ...
    engine.processOrder(Side::BUY, Type::LIMIT, 100, 9);   // id 1
    engine.processOrder(Side::SELL, Type::LIMIT, 100, 4);  // id 2, id 1 partially filled and still resting
...
TEST(MatchingEngineV6, CancelFullyFilledOrderId_NoMutation) {
    ...
    engine.processOrder(Side::BUY, Type::LIMIT, 100, 5);  // id 2, id 1 fully filled
